...
public class Order implements Serializable {
    ...
    //ANOTHER WAY TO DO OTHER THAN INPUTSTREAM
    public static JsonObject toJSON(String json) {
        jakarta.json.JsonReader r = (jakarta.json.JsonReader) Json.createReader(new StringReader(json));
        return r.readObject();
    }

    public static Order create(String jsonStr) {
        JsonObject o = toJSON(jsonStr);
        //Use pizza and delivery class to create object
        Pizza p = Pizza.create(o);
        Delivery d = Delivery.create(o);
        Order ord = new Order(p, d);
        ord.setOrderId(o.getString("order"));
    ...
    public JsonObject toJSoN() {
        return Json.createObjectBuilder()
            ...
            .add("quantity", this.getTotalCost())
